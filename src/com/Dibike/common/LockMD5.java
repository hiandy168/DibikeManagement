...
public class LockMD5 {
	...
	/*
	 * FF,GG,HH锟斤拷II锟斤拷锟斤拷锟斤拷F,G,H,I锟斤拷锟叫斤拷一锟斤拷锟戒换 FF, GG, HH, and II
	...
	/*
	 * b2iu锟斤拷锟斤拷写锟斤拷一锟斤拷锟斤拷byte锟斤拷锟秸诧拷锟斤拷锟斤拷锟斤拷诺锟皆
	 * 拷锟侥ｏ拷锟斤拷位锟斤拷锟斤拷锟斤拷锟斤拷为java没锟斤拷unsigned锟斤拷锟斤拷
	 */
